...
public class MediaController extends FrameLayout {
    ...
    private void initControllerView(View v) {
        ...
        if (mFullscreenListener != null)
            v.findViewById(getResources().getIdentifier("mediacontroller_fullscreen", "id", mContext.getPackageName()))
                    .setOnClickListener(mFullscreenListener);
    }
